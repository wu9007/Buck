...
class Formatter {
  ...
  /// 浮点保留一位小数
  static final WhitelistingTextInputFormatter floatReg1 = WhitelistingTextInputFormatter(RegExp(r'^(\d+)(.\d{0,1})?'));

  /// 浮点保留两位小数
  static final WhitelistingTextInputFormatter floatReg2 = WhitelistingTextInputFormatter(RegExp(r'^(\d+)(.\d{0,2})?'));
}
